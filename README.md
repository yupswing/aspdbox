...
<p>(Per vedere esempi pratici potete guardare i file DEMO presenti nel repository)</p>

<hr/>
<a id="aspdbmanager"></a>
<h2>Classe ASPdBManager</h2>
<p>Tutto ciò che bisogna sapere su questa classe è che prima di fare qualsiasi cosa (dopo ovviamente averla istanziata) è impostare un database (se non si imposta obj.database verrà considerato "mdb") e successivamente aprire una connessione, poi automaticamente tutti i metodi diventano disponibili e funzionanti, senza dimenticarsi di disconnettersi alla fine del lavoro/pagina<br /></p>
